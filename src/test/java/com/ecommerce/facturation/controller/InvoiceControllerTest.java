...
public class InvoiceControllerTest {
    ...
    public void testSaveInvoice() {
        ...
        InvoiceDTO invoiceDTO = new InvoiceDTO("hdd", LocalDateTime.now(), InvoiceStatus.Pending, BigDecimal.ZERO, new ClientDTO("hamza", "hamza@gmail.com", "marrakech", "+212662356987"), List.of(new CommandItemDto(1L, 5, BigDecimal.ONE, new ProductDto(1L, "Product1", BigDecimal.TEN)), new CommandItemDto(2L, 6, BigDecimal.TEN, new ProductDto(2L, "Product2", BigDecimal.TEN))));
    ...
    public void testFindAllInvoices() {
        InvoiceDTO invoiceDTO1 = new InvoiceDTO(1L, "hdd", LocalDateTime.now(), InvoiceStatus.Pending, BigDecimal.ZERO, new ClientDTO("hamza", "hamza@gmail.com", "marrakech", "+212662356987"), List.of(new CommandItemDto(1L, 5, BigDecimal.ONE, new ProductDto(1L, "Product1", BigDecimal.TEN)), new CommandItemDto(2L, 6, BigDecimal.TEN, new ProductDto(2L, "Product2", BigDecimal.TEN))));
        InvoiceDTO invoiceDTO2 = new InvoiceDTO(2L, "hdd", LocalDateTime.now(), InvoiceStatus.Pending, BigDecimal.ZERO, new ClientDTO("hamza", "hamza@gmail.com", "marrakech", "+212662356987"), List.of(new CommandItemDto(1L, 5, BigDecimal.ONE, new ProductDto(1L, "Product1", BigDecimal.TEN)), new CommandItemDto(2L, 6, BigDecimal.TEN, new ProductDto(2L, "Product2", BigDecimal.TEN))));
    ...
    public void testUpdateInvoice() {
        InvoiceDTO invoiceDTO = new InvoiceDTO(1L, "hdd", LocalDateTime.now(), InvoiceStatus.Pending, BigDecimal.ZERO, new ClientDTO("hamza", "hamza@gmail.com", "marrakech", "+212662356987"), List.of(new CommandItemDto(1L, 5, BigDecimal.ONE, new ProductDto(1L, "Product1", BigDecimal.TEN)), new CommandItemDto(2L, 6, BigDecimal.TEN, new ProductDto(2L, "Product2", BigDecimal.TEN))));
